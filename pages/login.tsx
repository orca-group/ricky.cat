        ...
        <div className="block border bg-white border-gray-500 rounded-md shadow-md p-8">
          ...
          <div className="text-sm">
            <p>
              ...
              <Link href="/register" className="ml-1 text-blue-400 hover:underline">Sign up here.</Link>
            </p>
            <p>
              Forgot your password?
              <Link href="/forgot-password" className="ml-1 text-blue-400 hover:underline">Reset it here.</Link>
            </p>
          </div>
        </div>
      </div>
